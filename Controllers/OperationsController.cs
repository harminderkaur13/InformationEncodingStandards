...
namespace Final_project.Controllers
{
    public class OperationsController : Controller
    {
        ...
        {
            var webJar = new CookieJar(); // get cookie jar from db
            await _authorizationService.AuthorizeAsync(User, webJar, CookieJarAuthOperations.Open);
            return View();
        }
    }
    ...
    {
        public static string Open = "display";
        public static string TakeCookie = "makedesign";
        public static string ComeNear = "tryediting";
        public static string Look = "confirmwork";
    }
